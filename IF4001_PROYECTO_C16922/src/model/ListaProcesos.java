...
public class ListaProcesos {
    ...
    // liberar recursos del proceso por numero de proceso
    public void liberarRecursoPorNProceso(int nProceso, int numeroRecurso) {
        Proceso proceso = buscarProceso(nProceso);
        if (proceso != null) {
            proceso.liberarRecursoPorNumero(numeroRecurso);
            System.out.println("Recurso " + numeroRecurso + " liberado del proceso " + nProceso);
        } else {
            System.out.println("Proceso con número " + nProceso + " no encontrado.");
        }
    }
}
